...
public interface IResourceGroupService
{
    ...
    Task<ResourceGroupInfo> CreateResourceGroup(string subscription, string resourceGroupName, string location, string? tenant = null, RetryPolicyOptions? retryPolicy = null);
}
